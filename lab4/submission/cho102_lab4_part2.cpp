...
*         Exercise Description: Single Light Show Speedup/Slowdown
*         I acknowledge all content contained herein, excluding template or example code, is my own original work.
*
*         Demo Link: https://youtu.be/WU50bFnqY8Y
*/
...
int SM1_Tick(int state){
    ...
    switch(state){ // State Action
      case INIT:
        ...
        break;
      case S0:
        writeBuffer(lights[0]);
        break;
      case S1:
        writeBuffer(lights[1]);
        break;
      case S2:
        writeBuffer(lights[2]);
        break;
      case S3:
        writeBuffer(lights[3]);
        break;
    }
